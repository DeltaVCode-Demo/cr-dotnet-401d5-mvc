...
namespace DemoMvc.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,FamilyId")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,FamilyId")] Person person)
        {
            if (id != person.Id)
            {
                return NotFound();
